studio.menu.addMenuItem({
    ...
    execute: function () {
        ...
        var dataTableComp = [
            ...
            "ENM,Ghost,Die,204",
            "ENM,Skeleton,Idle,205",
            "ENM,Ghost,Idle,206",
            "ENM,Skeleton,Attack,207",
            "ENM,Ghost,Attack,208",
            "ENM,Skeleton,Move,209",
            "ENM,Ghost,Move,210",
            "BOSS,AOE,Charge,301",
            "BOSS,AOE,Ground_Slam,302",
            "BOSS,AOE,Laser_Beam,303",
            "BOSS,general,Blast_Attack,304",
            "BOSS,general,Laser_Attack,305",
            "BOSS,general,Teleport,306",
            "BOSS,general,Appear,307",
            "BOSS,general,Idle,308",
            "BOSS,general,Death,309",
